...
Go to https://faucet.arkdev.info and use the `offchain_address` from the previous command to faucet your wallet with some sats.
...
To see your balance with your VTXOs expiration details:
...
Unilateral exit flag `--force` ignores the `--amount` flag, it will redeem all your VTXOs.
