...
func (a *adminHandler) UpdateMarketHourConfig(
	...
	if err := a.arkService.UpdateMarketHourConfig(ctx,
...
func (a *adminHandler) ListIntents(
	...
	intents, err := a.arkService.ListIntents(ctx, req.GetIntentIds()...)
	if err != nil {
		return nil, err
	}
...
func (a *adminHandler) DeleteIntents(
	...
	if err := a.arkService.DeleteIntents(ctx, req.GetIntentIds()...); err != nil {
		return nil, err
	}
