...
func (s *redisLiveStore) ConfirmationSessions() ports.ConfirmationSessionsStore { return s.confirmationSessionsStore }
func (s *redisLiveStore) TreeSigingSessions() ports.TreeSigningSessionsStore { return s.treeSigningSessions }
...
func (s *txRequestsStore) Push(request domain.TxRequest, boardingInputs []ports.BoardingInput, musig2Data *tree.Musig2) error { panic("not implemented") }
func (s *txRequestsStore) Pop(num int64) []ports.TimedTxRequest { panic("not implemented") }
func (s *txRequestsStore) Update(request domain.TxRequest, musig2Data *tree.Musig2) error { panic("not implemented") }
...
func (s *txRequestsStore) ViewAll(ids []string) ([]ports.TimedTxRequest, error) { panic("not implemented") }
func (s *txRequestsStore) View(id string) (*domain.TxRequest, bool) { panic("not implemented") }
func (s *txRequestsStore) IncludesAny(outpoints []domain.VtxoKey) (bool, string) { panic("not implemented") }

type forfeitTxsStore struct{}

func NewForfeitTxsStore() ports.ForfeitTxsStore { return &forfeitTxsStore{} }

func (s *forfeitTxsStore) Init(connectors tree.TxTree, requests []domain.TxRequest) error { panic("not implemented") }
...
func NewConfirmationSessionsStore() ports.ConfirmationSessionsStore { return &confirmationSessionsStore{} }
...
func (s *treeSigningSessionsStore) New(roundId string, uniqueSignersPubKeys map[string]struct{}) *ports.MusigSigningSession { panic("not implemented") }
func (s *treeSigningSessionsStore) Get(roundId string) (*ports.MusigSigningSession, bool) { panic("not implemented") }
