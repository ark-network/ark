...
var file_ark_v1_service_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0xb9, 0x01, 0x0a, 0x16, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x46, 0x69, 0x6e,
	...
	0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xfa, 0x01, 0x0a, 0x05, 0x52,
	...
	0x52, 0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x22, 0x2f, 0x0a, 0x05, 0x49, 0x6e, 0x70, 0x75, 0x74,
	...
	0x74, 0x54, 0x78, 0x69, 0x64, 0x22, 0xde, 0x01, 0x0a, 0x04, 0x56, 0x74, 0x78, 0x6f, 0x12, 0x29,
	...
	0x70, 0x6f, 0x6f, 0x6c, 0x54, 0x78, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x70, 0x65, 0x6e,
	0x74, 0x5f, 0x62, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x70, 0x65, 0x6e,
	...
	0x12, 0x14, 0x0a, 0x05, 0x73, 0x77, 0x65, 0x70, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x05, 0x73, 0x77, 0x65, 0x70, 0x74, 0x2a, 0x98, 0x01, 0x0a, 0x0a, 0x52, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x04, 0x32, 0xd8, 0x07, 0x0a, 0x0a, 0x41, 0x72, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x0b, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x6e, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x42, 0x92, 0x01, 0x0a,
...
var file_ark_v1_service_proto_goTypes = []interface{}{
	...
	(*Input)(nil),                   // 25: ark.v1.Input
	(*Output)(nil),                  // 26: ark.v1.Output
	(*Tree)(nil),                    // 27: ark.v1.Tree
	(*TreeLevel)(nil),               // 28: ark.v1.TreeLevel
	(*Node)(nil),                    // 29: ark.v1.Node
	(*Vtxo)(nil),                    // 30: ark.v1.Vtxo
}
var file_ark_v1_service_proto_depIdxs = []int32{
	25, // 0: ark.v1.RegisterPaymentRequest.inputs:type_name -> ark.v1.Input
	26, // 1: ark.v1.ClaimPaymentRequest.outputs:type_name -> ark.v1.Output
	24, // 2: ark.v1.GetRoundResponse.round:type_name -> ark.v1.Round
	24, // 3: ark.v1.GetRoundByIdResponse.round:type_name -> ark.v1.Round
	21, // 4: ark.v1.GetEventStreamResponse.round_finalization:type_name -> ark.v1.RoundFinalizationEvent
	22, // 5: ark.v1.GetEventStreamResponse.round_finalized:type_name -> ark.v1.RoundFinalizedEvent
	23, // 6: ark.v1.GetEventStreamResponse.round_failed:type_name -> ark.v1.RoundFailed
	21, // 7: ark.v1.PingResponse.event:type_name -> ark.v1.RoundFinalizationEvent
	30, // 8: ark.v1.ListVtxosResponse.spendable_vtxos:type_name -> ark.v1.Vtxo
	30, // 9: ark.v1.ListVtxosResponse.spent_vtxos:type_name -> ark.v1.Vtxo
	27, // 10: ark.v1.OnboardRequest.congestion_tree:type_name -> ark.v1.Tree
	27, // 11: ark.v1.RoundFinalizationEvent.congestion_tree:type_name -> ark.v1.Tree
	27, // 12: ark.v1.Round.congestion_tree:type_name -> ark.v1.Tree
	0,  // 13: ark.v1.Round.stage:type_name -> ark.v1.RoundStage
	28, // 14: ark.v1.Tree.levels:type_name -> ark.v1.TreeLevel
	29, // 15: ark.v1.TreeLevel.nodes:type_name -> ark.v1.Node
	25, // 16: ark.v1.Vtxo.outpoint:type_name -> ark.v1.Input
	26, // 17: ark.v1.Vtxo.receiver:type_name -> ark.v1.Output
	...
	10, // 32: ark.v1.ArkService.GetRoundById:output_type -> ark.v1.GetRoundByIdResponse
	12, // 33: ark.v1.ArkService.GetEventStream:output_type -> ark.v1.GetEventStreamResponse
	14, // 34: ark.v1.ArkService.Ping:output_type -> ark.v1.PingResponse
	16, // 35: ark.v1.ArkService.ListVtxos:output_type -> ark.v1.ListVtxosResponse
	18, // 36: ark.v1.ArkService.GetInfo:output_type -> ark.v1.GetInfoResponse
	20, // 37: ark.v1.ArkService.Onboard:output_type -> ark.v1.OnboardResponse
