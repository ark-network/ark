...
var file_ark_v1_service_proto_rawDesc = []byte{
	...
	0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf4, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74,
	...
	0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22,
	...
	0x0c, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xf1, 0x04,
...
var file_ark_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_ark_v1_service_proto_goTypes = []interface{}{
	...
	(*RoundFailed)(nil),             // 13: ark.v1.RoundFailed
	...
	nil,                             // 18: ark.v1.RoundFinalizationEvent.ForfeitTxsEntry
}
var file_ark_v1_service_proto_depIdxs = []int32{
	...
	18, // 3: ark.v1.RoundFinalizationEvent.forfeit_txs:type_name -> ark.v1.RoundFinalizationEvent.ForfeitTxsEntry
	...
	1,  // 13: ark.v1.ArkService.RegisterPayment:output_type -> ark.v1.RegisterPaymentResponse
	3,  // 14: ark.v1.ArkService.ClaimPayment:output_type -> ark.v1.ClaimPaymentResponse
	5,  // 15: ark.v1.ArkService.FinalizePayment:output_type -> ark.v1.FinalizePaymentResponse
	7,  // 16: ark.v1.ArkService.GetRound:output_type -> ark.v1.GetRoundResponse
	15, // 17: ark.v1.ArkService.GetEventStream:output_type -> ark.v1.GetEventStreamResponse
	17, // 18: ark.v1.ArkService.Ping:output_type -> ark.v1.PingResponse
