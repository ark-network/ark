...
type GetInfoResponse struct {
	...
	BoardingExitDelay          int64       `protobuf:"varint,7,opt,name=boarding_exit_delay,json=boardingExitDelay,proto3" json:"boarding_exit_delay,omitempty"`
	BoardingDescriptorTemplate string      `protobuf:"bytes,8,opt,name=boarding_descriptor_template,json=boardingDescriptorTemplate,proto3" json:"boarding_descriptor_template,omitempty"`
	VtxoDescriptorTemplates    []string    `protobuf:"bytes,9,rep,name=vtxo_descriptor_templates,json=vtxoDescriptorTemplates,proto3" json:"vtxo_descriptor_templates,omitempty"`
	ForfeitAddress             string      `protobuf:"bytes,10,opt,name=forfeit_address,json=forfeitAddress,proto3" json:"forfeit_address,omitempty"`
	MarketHour                 *MarketHour `protobuf:"bytes,11,opt,name=market_hour,json=marketHour,proto3" json:"market_hour,omitempty"`
	Version                    string      `protobuf:"bytes,12,opt,name=version,proto3" json:"version,omitempty"`
	UtxoMinAmount              int64       `protobuf:"varint,13,opt,name=utxo_min_amount,json=utxoMinAmount,proto3" json:"utxo_min_amount,omitempty"` // -1 means native dust limit (default)
	UtxoMaxAmount              int64       `protobuf:"varint,14,opt,name=utxo_max_amount,json=utxoMaxAmount,proto3" json:"utxo_max_amount,omitempty"` // -1 means no limit (default), 0 means boarding not allowed
	VtxoMinAmount              int64       `protobuf:"varint,15,opt,name=vtxo_min_amount,json=vtxoMinAmount,proto3" json:"vtxo_min_amount,omitempty"` // -1 means native dust limit (default)
	VtxoMaxAmount              int64       `protobuf:"varint,16,opt,name=vtxo_max_amount,json=vtxoMaxAmount,proto3" json:"vtxo_max_amount,omitempty"` // -1 means no limit (default)
}
...
var file_ark_v1_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x22, 0xa2, 0x05, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65,
	...
	0x74, 0x12, 0x2e, 0x0a, 0x13, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x78,
	0x69, 0x74, 0x5f, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x11,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x45, 0x78, 0x69, 0x74, 0x44, 0x65, 0x6c, 0x61,
	0x79, 0x12, 0x40, 0x0a, 0x1c, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x64, 0x65,
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1a, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x69, 0x6e,
	...
	0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x17, 0x76, 0x74, 0x78, 0x6f, 0x44, 0x65, 0x73, 0x63,
	...
	,
	...
	0x0c, 0x74, 0x61, 0x70, 0x72, 0x6f, 0x6f, 0x74, 0x5f, 0x74, 0x72, 0x65, 0x65, 0x22, 0x71, 0x0a,
	...
	0x32, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f,
	0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73,
	0x22, 0x37, 0x0a, 0x16, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x74, 0x65,
	...
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x5d, 0x0a, 0x06, 0x4d, 0x75, 0x73,
	...
	0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa7, 0x03, 0x0a, 0x16, 0x47, 0x65,
	...
	0x65, 0x6e, 0x74, 0x22, 0x2c, 0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x65, 0x22, 0x34, 0x0a, 0x15, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x64, 0x65, 0x65,
	0x6d, 0x54, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65,
	0x64, 0x65, 0x65, 0x6d, 0x5f, 0x74, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72,
	0x65, 0x64, 0x65, 0x65, 0x6d, 0x54, 0x78, 0x22, 0x56, 0x0a, 0x16, 0x53, 0x75, 0x62, 0x6d, 0x69,
	...
	0x6e, 0x65, 0x64, 0x52, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x54, 0x78, 0x12, 0x12, 0x0a, 0x04, 0x74,
	...
	0x52, 0x06, 0x72, 0x65, 0x64, 0x65, 0x65, 0x6d, 0x42, 0x04, 0x0a, 0x02, 0x74, 0x78, 0x32, 0xb2,
	0x0a, 0x0a, 0x0a, 0x41, 0x72, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4c, 0x0a,
	...
	0x72, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x9c, 0x01, 0x0a, 0x1b, 0x52, 0x65, 0x67, 0x69,
...
var file_ark_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_ark_v1_service_proto_goTypes = []interface{}{
	...
	(*MarketHour)(nil),                          // 23: ark.v1.MarketHour
	(*Tapscripts)(nil),                          // 24: ark.v1.Tapscripts
	(*Bip322Signature)(nil),                     // 25: ark.v1.Bip322Signature
	(*Output)(nil),                              // 26: ark.v1.Output
	...
	(*RoundTransaction)(nil),                    // 32: ark.v1.RoundTransaction
	(*RedeemTransaction)(nil),                   // 33: ark.v1.RedeemTransaction
}
var file_ark_v1_service_proto_depIdxs = []int32{
	23, // 0: ark.v1.GetInfoResponse.market_hour:type_name -> ark.v1.MarketHour
	24, // 1: ark.v1.GetBoardingAddressResponse.tapscripts:type_name -> ark.v1.Tapscripts
	25, // 2: ark.v1.RegisterIntentRequest.bip322_signature:type_name -> ark.v1.Bip322Signature
	26, // 3: ark.v1.RegisterOutputsForNextRoundRequest.outputs:type_name -> ark.v1.Output
	...
	32, // 10: ark.v1.GetTransactionsStreamResponse.round:type_name -> ark.v1.RoundTransaction
	33, // 11: ark.v1.GetTransactionsStreamResponse.redeem:type_name -> ark.v1.RedeemTransaction
	0,  // 12: ark.v1.ArkService.GetInfo:input_type -> ark.v1.GetInfoRequest
	2,  // 13: ark.v1.ArkService.GetBoardingAddress:input_type -> ark.v1.GetBoardingAddressRequest
	4,  // 14: ark.v1.ArkService.RegisterIntent:input_type -> ark.v1.RegisterIntentRequest
	7,  // 15: ark.v1.ArkService.RegisterOutputsForNextRound:input_type -> ark.v1.RegisterOutputsForNextRoundRequest
	9,  // 16: ark.v1.ArkService.SubmitTreeNonces:input_type -> ark.v1.SubmitTreeNoncesRequest
	11, // 17: ark.v1.ArkService.SubmitTreeSignatures:input_type -> ark.v1.SubmitTreeSignaturesRequest
	13, // 18: ark.v1.ArkService.SubmitSignedForfeitTxs:input_type -> ark.v1.SubmitSignedForfeitTxsRequest
	15, // 19: ark.v1.ArkService.GetEventStream:input_type -> ark.v1.GetEventStreamRequest
	17, // 20: ark.v1.ArkService.Ping:input_type -> ark.v1.PingRequest
	19, // 21: ark.v1.ArkService.SubmitRedeemTx:input_type -> ark.v1.SubmitRedeemTxRequest
	21, // 22: ark.v1.ArkService.GetTransactionsStream:input_type -> ark.v1.GetTransactionsStreamRequest
	1,  // 23: ark.v1.ArkService.GetInfo:output_type -> ark.v1.GetInfoResponse
	3,  // 24: ark.v1.ArkService.GetBoardingAddress:output_type -> ark.v1.GetBoardingAddressResponse
	5,  // 25: ark.v1.ArkService.RegisterIntent:output_type -> ark.v1.RegisterIntentResponse
	8,  // 26: ark.v1.ArkService.RegisterOutputsForNextRound:output_type -> ark.v1.RegisterOutputsForNextRoundResponse
	10, // 27: ark.v1.ArkService.SubmitTreeNonces:output_type -> ark.v1.SubmitTreeNoncesResponse
	12, // 28: ark.v1.ArkService.SubmitTreeSignatures:output_type -> ark.v1.SubmitTreeSignaturesResponse
	14, // 29: ark.v1.ArkService.SubmitSignedForfeitTxs:output_type -> ark.v1.SubmitSignedForfeitTxsResponse
	16, // 30: ark.v1.ArkService.GetEventStream:output_type -> ark.v1.GetEventStreamResponse
	18, // 31: ark.v1.ArkService.Ping:output_type -> ark.v1.PingResponse
	20, // 32: ark.v1.ArkService.SubmitRedeemTx:output_type -> ark.v1.SubmitRedeemTxResponse
	22, // 33: ark.v1.ArkService.GetTransactionsStream:output_type -> ark.v1.GetTransactionsStreamResponse
