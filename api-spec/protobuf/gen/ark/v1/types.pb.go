...
var file_ark_v1_types_proto_rawDesc = []byte{
	...
	0x64, 0x41, 0x74, 0x22, 0xd4, 0x01, 0x0a, 0x10, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x54, 0x72, 0x61,
	...
	0x72, 0x64, 0x69, 0x6e, 0x67, 0x55, 0x74, 0x78, 0x6f, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x52,
	...
	0x6f, 0x66, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x26, 0x0a, 0x0a, 0x54, 0x61, 0x70,
	...
	0x73, 0x22, 0x97, 0x01, 0x0a, 0x0a, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x48, 0x6f, 0x75, 0x72,
...
var file_ark_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_ark_v1_types_proto_goTypes = []interface{}{
	...
	nil,                                      // 24: ark.v1.RoundFinalizationEvent.ConnectorsIndexEntry
}
var file_ark_v1_types_proto_depIdxs = []int32{
	...
	13, // 4: ark.v1.Input.tapscripts:type_name -> ark.v1.Tapscripts
	...
	2,  // 13: ark.v1.SignedVtxoOutpoint.outpoint:type_name -> ark.v1.Outpoint
	11, // 14: ark.v1.SignedVtxoOutpoint.proof:type_name -> ark.v1.OwnershipProof
	15, // 15: ark.v1.ScheduledSweep.outputs:type_name -> ark.v1.SweepableOutput
	4,  // 16: ark.v1.TxRequestInfo.receivers:type_name -> ark.v1.Output
	18, // 17: ark.v1.TxRequestInfo.inputs:type_name -> ark.v1.RequestInput
	18, // 18: ark.v1.TxRequestInfo.boarding_inputs:type_name -> ark.v1.RequestInput
	5,  // 19: ark.v1.RoundFinalizationEvent.vtxo_tree:type_name -> ark.v1.Tree
	5,  // 20: ark.v1.RoundFinalizationEvent.connectors:type_name -> ark.v1.Tree
	24, // 21: ark.v1.RoundFinalizationEvent.connectors_index:type_name -> ark.v1.RoundFinalizationEvent.ConnectorsIndexEntry
	5,  // 22: ark.v1.RoundSigningEvent.unsigned_vtxo_tree:type_name -> ark.v1.Tree
	2,  // 23: ark.v1.RoundFinalizationEvent.ConnectorsIndexEntry.value:type_name -> ark.v1.Outpoint
