...
type V1GetTransactionsStreamResponse struct {
	...
	// commitment tx
	CommitmentTx *V1ArkTransaction `json:"commitmentTx,omitempty"`

	// virtual tx
	VirtualTx *V1ArkTransaction `json:"virtualTx,omitempty"`
}
...
func (m *V1GetTransactionsStreamResponse) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateVirtualTx(formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1GetTransactionsStreamResponse) validateVirtualTx(formats strfmt.Registry) error {
	if swag.IsZero(m.VirtualTx) { // not required
		return nil
	}

	if m.VirtualTx != nil {
		if err := m.VirtualTx.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("virtualTx")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("virtualTx")
			}
			return err
		}
	}
...
func (m *V1GetTransactionsStreamResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateVirtualTx(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1GetTransactionsStreamResponse) contextValidateVirtualTx(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.VirtualTx != nil {
		...
		if err := m.VirtualTx.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("virtualTx")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("virtualTx")
