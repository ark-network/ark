...
/*ArkServiceCompletePaymentOK handles this case with default header values.
...
func (o *ArkServiceCompletePaymentOK) Error() string {
	return fmt.Sprintf("[POST /v1/payment/complete][%d] arkServiceCompletePaymentOK  %+v", 200, o.Payload)
}
...
/*ArkServiceCompletePaymentDefault handles this case with default header values.
...
func (o *ArkServiceCompletePaymentDefault) Error() string {
	return fmt.Sprintf("[POST /v1/payment/complete][%d] ArkService_CompletePayment default  %+v", o._statusCode, o.Payload)
}
