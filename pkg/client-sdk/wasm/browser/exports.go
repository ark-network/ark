...
func init() {
	...
	js.Global().Set("onboardAgainAllExpiredOnboarding", OnboardAgainAllExpiredOnboardingWrapper())
	js.Global().Set("withdrawFromAllExpiredOnboarding", WithdrawFromAllExpiredOnboardingWrapper())
