...
type Indexer interface {
	...
	GetForfeitTxs(ctx context.Context, batchOutpoint Outpoint, opts ...RequestOption) (*ForfeitTxsResponse, error)
	GetConnectors(ctx context.Context, batchOutpoint Outpoint, opts ...RequestOption) (*ConnectorsResponse, error)
	GetVtxos(ctx context.Context, address string, opts ...GetVtxosRequestOption) (*VtxosResponse, error)
